...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        json_dir = os.path.join(settings.BASE_DIR, "data_store/dataservices/converted_json")
        ...
        spark = SparkSession.builder \
            .appName("ImportJSON") \
            .config("spark.jars", os.path.join(settings.BASE_DIR, "data_store/dataservices/postgresql-connector.jar")) \
            .getOrCreate()
